...
public class UserCheck {
	...
	public static void isValidPassword(User user) throws BusinessException {
		boolean tieneLetras=false;
		boolean tieneNumeros=false;
		String check = "La contraseña debe contener letras y numeros";
		...
		BusinessCheck.isTrue((tieneLetras && tieneNumeros),check);
    }
